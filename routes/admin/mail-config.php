...
Route::controller(MailConfigController::class)
    ...
    ->group(function () {
        ...
        Route::put('/update/{id}', 'update')->name('update')->middleware('permission:mail-config.edit');
        ...
        Route::delete('/destroy-all', 'destroyAll')->name('destroyAll')->middleware('permission:mail-config.delete');
    });