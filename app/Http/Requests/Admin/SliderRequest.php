...
class SliderRequest extends BaseAdminRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'image_desktop_en' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10240',
            'image_mobile_vn' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10240',
            'image_mobile_en' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:10240',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'image_desktop_vn.max' => 'Ảnh Desktop Tiếng Việt không được quá 10MB',
            'image_desktop_en.image' => 'Ảnh Desktop Tiếng Anh phải là hình ảnh',
            'image_desktop_en.max' => 'Ảnh Desktop Tiếng Anh không được quá 10MB',
            'image_mobile_vn.image' => 'Ảnh Mobile Tiếng Việt phải là hình ảnh',
            'image_mobile_vn.max' => 'Ảnh Mobile Tiếng Việt không được quá 10MB',
            'image_mobile_en.image' => 'Ảnh Mobile Tiếng Anh phải là hình ảnh',
            'image_mobile_en.max' => 'Ảnh Mobile Tiếng Anh không được quá 10MB',
        ];
    }
}
