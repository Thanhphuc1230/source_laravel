...
use App\Repositories\Eloquent\CateServiceRepository;
use App\Repositories\Eloquent\ServiceRepository;
use App\Repositories\Eloquent\CateProjectRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CateServiceRepositoryInterface::class, CateServiceRepository::class);
        $this->app->bind(ServiceRepositoryInterface::class, ServiceRepository::class);
        $this->app->bind(CateProjectRepositoryInterface::class, CateProjectRepository::class);
