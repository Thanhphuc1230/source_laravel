...
return new class extends Migration
{
    ...
    {
        Schema::create('tp_projects', function (Blueprint $table) {
            $table->id('id_project');
            ...
            $table->foreign('category_id')->references('id_cate_project')->on('tp_cate_projects')->onDelete('cascade');
            ...
            $table->index(['created_at', 'status']); // Covers: latest projects + status
        });
    }
