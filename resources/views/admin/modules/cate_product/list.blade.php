                                                ...
                                                <form id="delete-form-all"
                                                    ...
                                                    @foreach ($list as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->name_vn }} @if($item->parent_id != 0)<br> <span class="text-muted">Danh mục cha: {{ $item->parent->name_vn }}</span> @endif</td>
                                                            <td class="status">
                                                                <div
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="watch">
                                                                        <a href="{{ route('web.resolve',['id' => $item->id_cate_product, 'slug' => $item->slug]) }}" target="_blank"
