                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div>
                                        <a href="{{ route('web.resolve', ['id' => $page->id_page, 'slug' => $page->slug]) }}" target="_blank" class="text-decoration-none">
                                            <span>{{ request()->getSchemeAndHttpHost() }}/{{ $page->id_page }}-{{ $page->slug }}.html</span>
