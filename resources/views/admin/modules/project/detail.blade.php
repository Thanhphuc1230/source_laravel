                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">{{ $action == 'create' ? 'Thêm' : 'Chỉnh sửa' }} dự án
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Hình ảnh dự án</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="category_id" class="form-label">Danh mục dự án</label>
