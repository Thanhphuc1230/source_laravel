                                            ...
                                            <div class="list-group col nested-list nested-sortable">
                                                @foreach ($menus as $item)
                                                    <div class="list-group-item nested-1">
                                                        <span class="fs-15">{{ $item->name_vn }}</span>
                                                            ...
                                                            @if ($item->children)
                                                                @foreach ($item->children as $child)
                                                                    <div class="list-group-item nested-2"
                                                                        ...
                                                                        <span>{{ $child->name_vn }}</span>
                                                                        <span style="float: right">
                                                                            <button
                                                                                class="btn btn-secondary btn-sm waves-effect waves-light"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#showModal{{ $child->id_menu }}">Sửa</button>
                                                                            <a href="{{ route('admin.menu.destroy', ['uuid' => $child->uuid]) }}"
                                                                                onclick="return confirm('Xác nhận xóa menu ?')"
                                                                                class="btn btn-sm btn-danger remove-item-btn">Xóa</a>
                                                                        </span>
                                                                        {{-- subchild --}}
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                @foreach ($child->children as $subchild)
                                                                                    <div class="list-group-item nested-3"
                                                                                        style="padding-right: unset">
                                                                                        <span>{{ $subchild->name_vn }}</span>
                                                                                        <span style="float: right">
                                                                                            <button
                                                                                                class="btn btn-secondary btn-sm waves-effect waves-light"
                                                                                                data-bs-toggle="modal"
                                                                                                data-bs-target="#showModal{{ $subchild->id_menu }}">Sửa</button>
                                                                                            <a href="{{ route('admin.menu.destroy', ['uuid' => $subchild->uuid]) }}"
                                                                                                onclick="return confirm('Xác nhận xóa menu ?')"
                                                                                                class="btn btn-sm btn-danger remove-item-btn">Xóa</a>
                                                                                        </span>
                                                                                    </div>
