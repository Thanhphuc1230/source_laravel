                                            ...
                                            <ul class="list list-group list-group-flush mb-0">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link name text-body">Jonny Stromberg</a>
                                                            </h5>
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle"
                                                                    alt=""
                                                ...
                                                <li class="list-group-item" data-id="2">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link name text-body">Jonas Arnklint</a>
                                                            </h5>
                                                            <p class="born timestamp text-muted mb-0"
                                                ...
                                                <li class="list-group-item" data-id="3">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link name text-body">Martina Elm</a></h5>
                                                            <p class="born timestamp text-muted mb-0"
                                                ...
                                                <li class="list-group-item" data-id="4">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link name text-body">Gustaf Lindqvist</a>
                                                            </h5>
                                                            <p class="born timestamp text-muted mb-0"
                                                ...
                                                <li class="list-group-item" data-id="01">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            ...
                                                            <p class="contact-born text-muted mb-0">New updates for
                                                                ABC Theme</p>
                                                        </div>
                                                ...
                                                <li class="list-group-item" data-id="02">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            ...
                                                            <p class="contact-born text-muted mb-0">Bug Report - abc
                                                                theme</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                ...
                                                <li class="list-group-item" data-id="03">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <p class="contact-born text-muted mb-0">Nice to meet you
                                                            </p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                ...
                                                <li class="list-group-item" data-id="04">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <p class="contact-born text-muted mb-0">I've finished it!
                                                                See you so</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="fuzzysearch-list">
                                        <input type="text" class="fuzzy-search form-control mb-2"
                                            placeholder="Search" />
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center pagi-list">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link text-body">Jonny Stromberg</a></h5>
                                                            <p class="born timestamp text-muted mb-0">Front end
                                                                Developer</p>
                                                        </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center pagi-list">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 mb-1"><a href="#"
                                                                    class="link text-body">Martina Elm</a></h5>
                                                            <p class="born fs-12 timestamp text-muted mb-0">UI/UX
                                                                Designer</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div>
